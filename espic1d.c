...
// For the Project thesis of Hydrodynamic Description of Quantum Plasma , we modified the original code at github repo : https://github.com/letapk/espic1d
// with all copyrights and credits of the original code as mentioned above to Kartik Patel
// We modiefied the code for getting plots of Charge density , Electric Field , Velocity distribution , Position
// distribution , Time history plots of Kinetic energy , electric energy , total energy
/*
 * Compile:
